...
with open(os.path.join(AGENT_BASE_DIR, "agents/prompts/definitions/analyst/core.yaml"), "r") as f:
...
persistent_knowledge_path = os.path.join(AGENT_BASE_DIR, "agents/prompts/definitions/analyst/persistent_knowledge.yaml")
...
reflection_knowledge_path = os.path.join(AGENT_BASE_DIR, "agents/prompts/definitions/analyst/reflection_knowledge.yaml")
...
if agent_definition.get("add_examples", False):
    with open(os.path.join(AGENT_BASE_DIR, "agents/prompts/definitions/analyst/examples.yaml"), "r") as f:
...
if agent_definition.get("add_reflection_examples", False):
    reflection_examples_path = os.path.join(AGENT_BASE_DIR, "agents/prompts/definitions/analyst/reflection_examples.yaml")
...
_builder = PromptBuilder(
    agent_definition_path=os.path.join(AGENT_BASE_DIR, "agents/prompts/definitions/analyst/core.yaml")
)
_builder.agent_template = agent_definition


ANALYST_SYSTEM_PROMPT = _builder.build()


def get_dynamic_analyst_system_prompt() -> str:
    ...
    tactical_knowledge = get_tactical_knowledge("analyst")
